          ...
          <div className="font-body flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="text-ebony-clay rounded-lg border border-gray-200 bg-white px-3 py-1 disabled:opacity-50 dark:border-gray-700 dark:bg-gray-800 dark:text-white"
              >
                Previous
              </button>
              <button
